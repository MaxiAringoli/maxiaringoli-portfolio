...
const experience = [
  ...
  { company: 'Mercado Libre', duration: 'Actualidad · casi 4 años', detail: 'Desarrollador SSr' },
]
...
function App() {
  return (
    <div className="site-shell">
      ...
      <main>
        <section className="hero section" id="inicio">
          <div className="hero-copy">
            ...
            <p className="hero-lead">Soy Maxi Aringoli, desarrollador Full Stack. Diseño, construyo y pongo en producción soluciones digitales para profesionales, comercios y empresas que necesitan algo más que una web.</p>
      ...
      <footer><a className="brand" href="#inicio">MAXI ARINGOLI</a><span>Desarrollo de Software · Soluciones digitales</span><span>© 2026 Maxi Aringoli</span></footer>
    </div>
  )
}
